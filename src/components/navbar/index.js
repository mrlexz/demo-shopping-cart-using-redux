            ...
            <div className="container">
                ...
                <div className="collapse navbar-collapse" id="ftco-nav">
                    <ul className="navbar-nav ml-auto">
                        ...
                        {props.infor.is_superuser && <li className="nav-item"><NavLink to="/management" className="nav-link">Managenement</NavLink></li>}
                        {!props.infor.isLogin && <li className="nav-item"><NavLink to="/register" className="nav-link">Register</NavLink></li>}
                    </ul>
                </div>
            </div>
        </nav>
